...
import com.android.settings.widget.PieBarPreference;
...
public class PieTriggerSettings extends SettingsPreferenceFragment
    ...
    private static final String TAG = "PieTriggerSettings";
    ...
    private PieBarPreference mPieTriggerThickness;
    private PieBarPreference mPieTriggerHeight;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPieTriggerThickness = (PieBarPreference) findPreference(PREF_PIE_TRIGGER_THICKNESS);
        mPieTriggerThickness.setOnPreferenceChangeListener(this);
        mPieTriggerHeight = (PieBarPreference) findPreference(PREF_PIE_TRIGGER_HEIGHT);
        ...
        alertDialog.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                Settings.System.putFloat(getActivity().getContentResolver(),
                    ...
                    mSystemUiResources.getIdentifier("spie_trigger_thickness",
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mPieTriggerThickness) {
            ...
            Settings.System.putFloat(getActivity().getContentResolver(),
                    Settings.System.SPIE_TRIGGER_THICKNESS, value);
            return true;
            ...
            Settings.System.putFloat(getActivity().getContentResolver(),
                    Settings.System.SPIE_TRIGGER_HEIGHT, value);
            return true;
            ...
            Settings.System.putInt(getContentResolver(),
                    Settings.System.SPIE_TRIGGER_GRAVITY_LEFT_RIGHT, value);
    ...
    public void onResume() {
        ...
        Settings.System.putInt(getActivity().getContentResolver(),
                Settings.System.SPIE_TRIGGER_SHOW, 1);
    ...
    public void onPause() {
        super.onPause();
        Settings.System.putInt(getActivity().getContentResolver(),
                Settings.System.SPIE_TRIGGER_SHOW, 0);
    ...
    private void updatePieTriggers() {
        ...
        mMaxTriggerThickness = mSystemUiResources.getDimension(
                    mSystemUiResources.getIdentifier("spie_trigger_max_thickness",
                    "dimen", "com.android.systemui"));
        mMinTriggerThickness = mSystemUiResources.getDimension(
                    mSystemUiResources.getIdentifier("spie_trigger_min_thickness",
                    "dimen", "com.android.systemui"));
