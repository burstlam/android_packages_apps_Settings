...
public class SoundSteps extends SettingsPreferenceFragment implements
        Preference.OnPreferenceChangeListener {
    private static final String TAG = "SoundSteps";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.sound_steps);

        boolean isPhone = activePhoneType != TelephonyManager.PHONE_TYPE_NONE;
        PreferenceCategory soundStep = (PreferenceCategory) getPreferenceScreen().findPreference("category_volume_steps");
        ...
        if (isPhone) {
            ...
            soundStep.removePreference(mVolumeStepsDTMF);
        }
        ...
        if (isPhone) {
            ...
            soundStep.removePreference(mVolumeStepsRing);
        }
        ...
        if (isPhone) {
            ...
            soundStep.removePreference(mVolumeStepsVoiceCall);
        }
    }
