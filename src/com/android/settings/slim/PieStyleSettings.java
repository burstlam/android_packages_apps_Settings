...
public class PieStyleSettings extends SettingsPreferenceFragment
    ...
    PieBarPreference mPieBackgroundAlpha;
    PieBarPreference mPieControlSize;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPieBackgroundAlpha = (PieBarPreference) findPreference(PREF_PIE_BACKGROUND_ALPHA);
        mPieBackgroundAlpha.setOnPreferenceChangeListener(this);

        mPieControlSize = (PieBarPreference) findPreference(PREF_PIE_CONTROL_SIZE);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mPieBackgroundAlpha) {
            ...
            Settings.System.putFloat(getActivity().getContentResolver(),
                    Settings.System.SPIE_BACKGROUND_ALPHA, val / 100);
            return true;
            ...
            Settings.System.putFloat(getActivity().getContentResolver(),
                    Settings.System.SPIE_SIZE, value);
            return true;
