...
public class PieButtonStyleSettings extends SettingsPreferenceFragment
    ...
    PieBarPreference mPieButtonAlpha;
    PieBarPreference mPieButtonPressedAlpha;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPieButtonAlpha = (PieBarPreference) findPreference(PREF_PIE_BUTTON_ALPHA);
        mPieButtonAlpha.setOnPreferenceChangeListener(this);

        mPieButtonPressedAlpha = (PieBarPreference) findPreference(PREF_PIE_BUTTON_PRESSED_ALPHA);
