...
public class ListViewAnimation extends SettingsPreferenceFragment implements
    ...
    private SeekBarPreference2 mListViewDuration;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.animation_listview_interface);
        ...
        mListViewCache = (ListPreference) findPreference(KEY_LISTVIEW_CACHE);
        ...
        mListViewDuration = (SeekBarPreference2) findPreference(LISTVIEW_ANIM_DURATION);
        mListViewDuration.setValue(listviewDuration);
        mListViewDuration.setOnPreferenceChangeListener(this);

        mExcludedAppsPref = (AppMultiSelectListPreference) findPreference(KEY_LISTVIEW_EXCLUDED_APPS);
