...
public class SystemAnimation extends SettingsPreferenceFragment implements
    ...
    private SeekBarPreference2 mAnimationDuration;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.animation_system_interface);
        ...
        mAnimationDuration = (SeekBarPreference2) findPreference(ANIMATION_DURATION);
