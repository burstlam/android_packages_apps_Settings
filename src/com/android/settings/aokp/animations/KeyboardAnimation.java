...
public class KeyboardAnimation extends SettingsPreferenceFragment implements
        Preference.OnPreferenceChangeListener {
    private static final String TAG = "KeyboardAnimation";
    ...
    private SeekBarPreference2 mAnimationImeDuration;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.animation_keyboard_interface);
        ...
        mAnimationImeEnter = (ListPreference) findPreference(IME_ENTER_ANIMATION);
        ...
        mAnimationImeExit = (ListPreference) findPreference(IME_EXIT_ANIMATION);
        ...
        mAnimationImeInterpolator = (ListPreference) findPreference(IME_INTERPOLATOR);
        ...
        mAnimationImeDuration = (SeekBarPreference2) findPreference(IME_ANIM_DURATION);
