...
public class ProgressBar extends SettingsPreferenceFragment implements
    ...
    private SeekBarPreference2 mprogressbar_speed;
    private SeekBarPreference2 mprogressbar_width;
    private SeekBarPreference2 mprogressbar_length;
    private SeekBarPreference2 mprogressbar_count;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.animation_progressbar);
        ...
        mprogressbar_speed = (SeekBarPreference2) findPreference(PROGRESSBAR_SPEED);
        ...
        mprogressbar_width = (SeekBarPreference2) findPreference(PROGRESSBAR_WIDTH);
        ...
        mprogressbar_length = (SeekBarPreference2) findPreference(PROGRESSBAR_LENGTH);
        ...
        mprogressbar_count = (SeekBarPreference2) findPreference(PROGRESSBAR_COUNT);
