...
public class HardwareKeys extends SettingsPreferenceFragment implements OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mEnableCustomBindings = (CheckBoxPreference) getPreferenceScreen().findPreference(
        ...
        mAssistPressAction = (ListPreference) getPreferenceScreen().findPreference(
                HARDWARE_KEYS_ASSIST_PRESS);
        mAssistLongPressAction = (ListPreference) getPreferenceScreen().findPreference(
